...
namespace Chinmaya.Registration.BAL.Controllers
{
    public class AccountController : ApiController
    {
		...
		[Route("api/Account/GetCenterState/{id}")]
		[HttpGet]
		public List<KeyGuidValueModel> GetCenterState(Guid id)
		{
			return _common.GetCenterState(id);
		}

		[Route("api/Account/GetCenterCity/{id}")]
		[HttpGet]
		public List<KeyGuidValueModel> GetCenterCity(Guid id)
		{
			return _common.GetCenterCity(id);
		}

		[Route("api/Account/GetCenters/{id}")]
		[HttpGet]
		public List<KeyGuidValueModel> GetCenters(Guid id)
		{
			return _common.GetCenters(id);
		}
	}
}
