...
namespace Chinmaya.Registration.BAL.Controllers
{
    public class UserController : ApiController
    {
		...
		[Route("api/User/GetTeacherData/")]
		[HttpGet]
		public IEnumerable<TeacherModel> GetTeacherData()
		{
			return _user.GetTeacherData();
		}

		[Route("api/User/GetEmailById/{id}")]
		[HttpGet]
		public UpdateEmail GetEmailById(string id)
		{
			return _user.GetEmailById(id);
		}

		[Route("api/User/GetTransactionInformation/{id}")]
		[HttpGet]
		public IEnumerable<TransactionInfo> GetTransactionInformation(string id)
		{
			return _user.GetTransactionInformation(id);
		}

		[Route("api/User/GetCenterCountryData")]
		[HttpGet]
		public object GetCenterCountryData()
		{
			return _user.GetCenterCountryData();
		}
	}
}
