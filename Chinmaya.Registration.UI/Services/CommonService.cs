...
namespace Chinmaya.Registration.UI.Services
{
    public class CommonService
    {
        ...
        public async Task<List<KeyGuidValueModel>> GetRelationshipData()
        {
        ...
        /// </summary>
        /// <returns> list of genders </returns>
        public async Task<List<KeyGuidValueModel>> GetGradeData()
        {
		...
		public async Task<List<KeyGuidValueModel>> GetCenterCountryData()
		{
			HttpResponseMessage roleResponseMessage = await Utility.GetObject("/api/User/GetCenterCountryData", true);
			return await Utility.DeserializeObject<List<KeyGuidValueModel>>(roleResponseMessage);
		}
	}
}