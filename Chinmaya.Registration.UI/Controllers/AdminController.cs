...
namespace Chinmaya.Registration.UI.Controllers
{
    ...
    public class AdminController : BaseController
    {
		...
		{
			List<TeacherModel> teacherData = new List<TeacherModel>();
			teacherData = await _user.GetTeacherData();
			return View("TeacherManagement", teacherData);
		}

		public async Task<string> DeleteUser(string Id)
		{
			HttpResponseMessage userResponseMessage = await Utility.GetObject("/api/Account/DeleteUser/" + Id, Id, true);
